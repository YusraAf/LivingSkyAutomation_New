...
public void dragIdeaFromDocument() throws InterruptedException {
	...
	driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/section[1]/div[1]/div[3]/div[1]/div[2]/div[1]/button[1]")).click();
    driver.findElement(By.xpath("//reach-portal[2]/div/div/div[2]")).click();
   
    Thread.sleep(1000);
    
    WebElement element = driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/section[1]/div[1]/div[3]/div[1]/div[2]/div[1]"));
    WebElement target = driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/section[1]/div[1]/div[1]/div[1]/div[1]/div[1]"));
